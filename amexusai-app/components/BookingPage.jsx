...
export default function BookingPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      {/* Left Section */}
      <div className="w-full md:w-1/2 relative flex flex-col justify-evenly px-6 md:px-14 py-12 md:py-20 text-white bg-[#0A0F1D] min-h-[60vh] md:min-h-full overflow-hidden">
        <Image
          src="/BgImage.png"
          alt="Background"
          fill
          ...
          quality={75}
        />
        <div className="relative z-10 flex flex-col justify-evenly h-full w-full">
          <div className="flex justify-center md:justify-start">
            <Image
              ...
              width={200}
              height={67}
              className="w-32 md:w-50 h-auto mb-4 md:mb-6"
            />
          </div>
          <div className="text-center md:text-left">
            <h1 className="text-3xl md:text-6xl font-bold mb-4 md:mb-10 leading-tight">
              ...
              <br className="hidden md:block" /> Your Business with{" "}
              <br className="hidden md:block" /> Custom AI Solutions
            </h1>
            <p className="text-[#9A9A9A] font-roboto-slab text-base md:text-2xl mb-4 md:mb-6">
              Amexus AI empowers businesses with custom-built agents that
